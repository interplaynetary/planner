...
<style>
  ...
  .ft-na      { opacity: 0.45; }
  .price-input { width: 60px; background: var(--border-faint); border: 1px solid var(--border-dim); border-radius: 3px; color: #e2e8f0; font-family: var(--font-mono); font-size: var(--text-xs); padding: 2px 5px; }
