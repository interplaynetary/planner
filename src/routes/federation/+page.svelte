<script lang="ts">
  ...
  const demandSpecs: ResourceSpecification[] = [
    ...
    // Frontier Tower specs
    { id: "meals",            name: "Meals",            image: "🍽️", defaultUnitOfResource: "serving", resourceClassifiedAs: ["individual-claimable"] },
    { id: "coffee",           name: "Coffee",           image: "☕", defaultUnitOfResource: "cup",     resourceClassifiedAs: ["individual-claimable"] },
    { id: "supplements",      name: "Supplements",      image: "💊", defaultUnitOfResource: "dose",    resourceClassifiedAs: ["individual-claimable"] },
    { id: "fitness-sessions", name: "Fitness Sessions",  image: "🏋️", defaultUnitOfResource: "session", resourceClassifiedAs: ["individual-claimable"] },
    { id: "compute",          name: "GPU Compute",      image: "🖥️", defaultUnitOfResource: "hr" },
    { id: "electronics",      name: "Electronics",      image: "⚡", defaultUnitOfResource: "unit" },
    { id: "media-content",    name: "Media Content",    image: "🎬", defaultUnitOfResource: "unit" },
    { id: "fabricated-parts", name: "Fabricated Parts",  image: "🔩", defaultUnitOfResource: "unit" },
    { id: "prototypes",       name: "Prototypes",       image: "🤖", defaultUnitOfResource: "unit" },
    { id: "consulting",       name: "Consulting",       image: "💼", defaultUnitOfResource: "hr" },
    { id: "bio-samples",      name: "Bio Samples",      image: "🧬", defaultUnitOfResource: "unit" },
    { id: "event-tickets",    name: "Event Tickets",    image: "🎫", defaultUnitOfResource: "unit" },
    { id: "ventures",         name: "Ventures",         image: "🚀", defaultUnitOfResource: "unit" },
    { id: "node-infra",       name: "Node Infra",       image: "🌐", defaultUnitOfResource: "unit" },
    { id: "wellness-pgm",     name: "Wellness Programs", image: "🧘", defaultUnitOfResource: "session" },
    { id: "lab-reagents",     name: "Lab Reagents",     image: "🧪", defaultUnitOfResource: "kit" },
    { id: "3d-filament",      name: "3D Filament",      image: "🧵", defaultUnitOfResource: "kg" },
    { id: "coffee-beans",     name: "Coffee Beans",     image: "🫘", defaultUnitOfResource: "kg" },
    { id: "ai-models",        name: "AI Models",        image: "🧠", defaultUnitOfResource: "unit" },
  ];
